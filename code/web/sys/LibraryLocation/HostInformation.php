...
class HostInformation extends DataObject
{
	...
	public static function getObjectStructure() : array {
		...
		return [
			...
			'defaultPath' => array('property' => 'defaultPath', 'type'=>'text', 'label'=>'Default Path', 'description' => 'The default path that will be used if no path is provided', 'maxLength' => 50, 'default'=>'/Search/Home'),
		];
	}
}