			...
			if ($sideLoadConfiguration->find(true) && !empty($sideLoadConfiguration->marcPath)) {
				...
				if (file_exists($fullName)){
					if (unlink($fullName)){
						...
						return ['success' => true, 'message' => 'The file was deleted.'];
					}else{
						return ['success' => false, 'message' => 'The file could not be deleted.'];
					}
				}else{
					return ['success' => false, 'message' => 'Could not find the file to download.'];
				}
			}else{
				return ['success' => false, 'message' => 'Could not find the Side Load for this file.'];
			}
		}else{
