	...
	function eventRegistrationModal() {
		...
		if(isset($_REQUEST['vendor'])) {
			...
			return [
				...
				'body' => $body,
				'buttons' => '<a href="' . $eventUrl . '" class="btn btn-primary" target="_blank" aria-label="'.translate(['text' => 'Go to Registration', 'isPublicFacing' => true]).' ('.translate(['text' => 'opens in a new window', 'isPublicFacing' => true]).')"><i class="fas fa-external-link-alt" role="presentation"></i> ' . translate([
