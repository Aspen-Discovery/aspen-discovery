{strip}
	<div id="main-content" class="col-md-12">
		<h1>{translate text="Palace Project Export Log" isAdminFacing=true}</h1>
				...
				<tbody>
					{foreach from=$logEntries item=logEntry}
						<tr>
							...
							<td><a href="#" onclick="return AspenDiscovery.Admin.showExtractNotes('{$logEntry->id}', 'palace_project');">{translate text="Show Notes" isAdminFacing=true}</a></td>
						</tr>
					{/foreach}
				</tbody>
			</table>
