...
class AccountProfile extends DataObject {
	...
	static function getObjectStructure() : array {
		return array(
			...
			'ils' => array('property' => 'ils', 'type' => 'enum', 'label' => 'ILS', 'values' => ['na' => 'None', 'koha' => 'Koha', 'carlx' => 'Carl.X', 'evergreen' => 'Evergreen', 'evolve' => 'Evolve', 'folio' => 'Folio', 'horizon' => 'Horizon', 'millennium' => 'Millennium', 'polaris' => 'Polaris', 'sierra' => 'Sierra', 'symphony' => 'Symphony'], 'description' => 'The ils of the account profile', 'required' => true, 'default' => 'koha'),
			...
			'oAuthSection'=>array('property'=>'oAuthSection', 'type' => 'section', 'label' =>'API/OAuth2 Information (optional)', 'hideInLists' => true, 'properties' => array(
					...
					'oAuthClientSecret' => array('property' => 'oAuthClientSecret', 'type' => 'storedPassword', 'label' => 'API/OAuth2 Secret', 'maxLength' => 50, 'description' => 'The Client Secret to use when making a connection to APIs', 'required' => false),
