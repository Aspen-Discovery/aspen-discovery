...
class RBdigital_Dashboard extends Admin_Dashboard {
	function launch() {
		...
		[
			...
			$loansThisMonth,
			$holdsThisMonth,
			$activeMagazinesThisMonth,
			$magazineLoansThisMonth,
		...
		[
			...
			$loansLastMonth,
			$holdsLastMonth,
			$activeMagazinesLastMonth,
			$magazineLoansLastMonth,
		...
		[
			...
			$loansThisYear,
			$holdsThisYear,
			$activeMagazinesThisYear,
			$magazineLoansThisYear,
		...
		[
			...
			$loansLastYear,
			$holdsLastYear,
			$activeMagazinesLastYear,
			$magazineLoansLastYear,
		...
		[
			...
			$loansAllTime,
			$holdsAllTime,
			$activeMagazinesAllTime,
			$magazineLoansAllTime,
