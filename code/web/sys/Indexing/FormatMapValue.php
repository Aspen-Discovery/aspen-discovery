...
class FormatMapValue extends DataObject
{
	...
	static function getObjectStructure() : array
	{
		...
		return array(
			...
			'pickupAt' => array('property' => 'pickupAt', 'type' => 'enum', 'values' => [0 => 'Any valid location', 2 => 'Holding Library', 1 => 'Holding Location'], 'label' => 'Pickup at', 'description' => 'When placing holds, only branches where the item is can be used as pickup locations.', 'default' => 0, 'required' => true, 'forcesReindex' => false),
		);
	}
}