			...
			<div class="adminPanel">
				...
				<div class="adminSectionActions row">
					<div class="col-tn-12">
						...
						<div class="adminAction row">
							<div class="col-tn-2 col-xs-1 col-sm-2 col-md-1 adminActionLabel">
								<a href="/Greenhouse/CoverManager" title="{translate text="Cover Manager" inAttribute="true" isAdminFacing=true}"><i class="fas fa-chevron-circle-right fa"></i></a>
							</div>
							<div class="col-tn-10 col-xs-11 col-sm-10 col-md-11">
								<div class="adminActionLabel"><a href="/Greenhouse/CoverManager">{translate text="Cover Manager"  isAdminFacing=true}</a></div>
							</div>
						</div>
					</div>
				</div>
