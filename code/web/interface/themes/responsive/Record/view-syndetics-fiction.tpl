...
<div class='fictionProfileTitle'>{translate text="Characters"}</div>
...
<div class='fictionProfileTitle'>{translate text="Topics"}</div>
...
<div class='fictionProfileTitle'>{translate text="Settings"}</div>
...
{if isset($fictionData.settings)}
<div class='fictionProfileTitle'>{translate text="Genres"}</div>
...
<div class='fictionProfileTitle'>{translate text="Awards"}</div>
