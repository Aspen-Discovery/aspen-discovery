...
{if $recordDriver}<a href="/GroupedWork/{$recordDriver->getPermanentId()}">{$recordDriver->getShortTitle()|removeTrailingPunctuation|truncate:30:"..."|escape}</a> <span class="divider">&raquo;</span>
