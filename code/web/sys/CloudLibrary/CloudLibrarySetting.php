...
class CloudLibrarySetting extends DataObject
{
	...
	public static function getObjectStructure() : array
	{
		...
		return array(
			...
			'libraryId' => array('property' => 'libraryId', 'type' => 'text', 'label' => 'Library Id', 'description' => 'The library id provided by cloudLibrary'),
			'accountId' => array('property' => 'accountId', 'type' => 'text', 'label' => 'Account Id', 'description' => 'The Account Id provided by cloudLibrary when registering'),
			'accountKey' => array('property' => 'accountKey', 'type' => 'text', 'label' => 'API Token', 'description' => 'The Account Key provided by cloudLibrary when registering'),
