			...
			<fieldset>
				...
				<p class="alert alert-info">
                    ...
                    {if $showDetailedHoldNoticeInformation && $profile->_noticePreferenceLabel == 'Mail' && !$treatPrintNoticesAsPhoneNotices}
						Once the title arrives at your library you will be mailed a notification informing you that the title is ready for you.&nbsp;
                    {elseif $showDetailedHoldNoticeInformation && ($profile->_noticePreferenceLabel == 'Telephone' || ($profile->_noticePreferenceLabel eq 'Mail' && $treatPrintNoticesAsPhoneNotices))}
						Once the title arrives at your library you will receive a phone call informing you that the title is ready for you.&nbsp;
                    {elseif $showDetailedHoldNoticeInformation && $profile->_noticePreferenceLabel == 'Email'}
						Once the title arrives at your library you will be emailed a notification informing you that the title is ready for you.&nbsp;
                    {elseif $showDetailedHoldNoticeInformation}
								...
								<select name="pickupBranch" id="pickupBranch" class="form-control">
		                            {if count($pickupLocations) > 0}
		                                {foreach from=$pickupLocations item=location}
		                                    ...
		                                    {else}
												<option value="{$location->code}"{if $location->getSelected() == "selected"} selected="selected"{/if}
