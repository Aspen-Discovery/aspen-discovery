...
class WorkAPI extends AbstractAPI {
	...
	function launch() : void {
		...
		$this->handleAPIRequestAuto($method, 'work_api');
	}
	...
	/**
	 * Gets rating information for a work. Called as an API as well as internally from other PHP files
	 *
	 * @param string|null $permanentId
	 * @return array
	 */
	public function getRatingData(?string $permanentId = null) {
		global $timer;
