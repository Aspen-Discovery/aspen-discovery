...
class UserNotification extends DataObject
{
	...
	public static function getObjectStructure() {
		return [
			...
			'message' => ['property' => 'message', 'type' => 'text', 'label' => 'Message', 'description' => 'A message returned by the notification API', 'readOnly' => true]
		];
	}
	...
	function __get($name){
		if ($name == 'user'){
			if(empty($this->userId)){
				return translate(['text' => 'Unknown', 'isPublicFacing'=>true]);
			}
