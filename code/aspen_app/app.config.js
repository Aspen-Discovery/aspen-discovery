export default {
    ...
    extra: {
        apiKey1: process.env.API_KEY_1 ?? 'fluffyflower',
        apiKey2: process.env.API_KEY_2 ?? 'fluffyflower',
        apiKey3: process.env.API_KEY_3 ?? 'fluffyflower',
        apiKey4: process.env.API_KEY_4 ?? 'fluffyflower',
        apiKey5: process.env.API_KEY_5 ?? 'fluffyflower',
    }
};