...
class SideLoad extends DataObject
{
	...
	static function getObjectStructure()
	{
		...
		$structure = array(
			...
			'recordDriver' => array('property' => 'recordDriver', 'type' => 'text', 'label' => 'Record Driver', 'maxLength' => 50, 'description' => 'The record driver to use while displaying information in Pika', 'required' => true, 'hideInLists' => true, 'default' => 'SideLoadedRecord, \'forcesReindex\' => true'),
