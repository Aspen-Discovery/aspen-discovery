...
class OpenArchivesCollection extends DataObject
{
	...
	static function getObjectStructure() : array
	{
		...
		return [
			...
			'imageRegex' => array('property' => 'imageRegex', 'type' => 'multilineRegularExpression', 'label' => 'Image Regular Expression', 'description' => 'A regular expression to extract the thumbnail.', 'note'=>'Used to extract thumbnails, can be blank, the first capturing group is used for the value, can put multiple expressions on their own line'),
