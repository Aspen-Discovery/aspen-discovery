...
//alexander 
### New Settings
- Added control over whether images available from the API are used in a Summon Search or whether Aspen created covers only should be used - impacts load speed. Primary Configuration > Library Systems. (*AB*)
