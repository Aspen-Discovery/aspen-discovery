...
class Admin_PayPalPayflowSettings extends ObjectEditor {
	function getObjectType(): string {
		return 'PayPalPayflowSetting';
	}

	function getToolName(): string {
		return 'PayPalPayflowSettings';
	}
	...
	function getObjectStructure($context = ''): array {
		return PayPalPayflowSetting::getObjectStructure($context);
	}
	...
	function getBreadcrumbs(): array {
		...
		$breadcrumbs[] = new Breadcrumb('', 'PayPal Payflow Settings');
		return $breadcrumbs;
	}
