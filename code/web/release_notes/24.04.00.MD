...
- Update audience determination for cloudLibrary to look for Young Adult titles and look at more subjects for Juvenile titles. (*MDN*)
...
- Check for and suppress items with no item identifier in Koha extracts. (*MDN*)
...
- Don't show checkouts and holds that are not part of the active collection and improve loading formats for Palace Project titles. (Ticket 129674) (*MDN*)
...
### Polaris Updates
- Correct Polaris indexing to have 15 minute buffer when loading changed records. (Tickets 128584, 124477) (*MDN*)
