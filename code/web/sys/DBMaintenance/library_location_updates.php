...
function getLibraryLocationUpdates() {
	return [
		...
		'library_materials_request_limits' => [
		...
		'library_links' => [
			...
			'continueOnError' => true,
			'sql' => [
				"CREATE TABLE IF NOT EXISTS library_links (" . "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, " . "libraryId INT NOT NULL, " . "category VARCHAR(100) NOT NULL, " . "linkText VARCHAR(100) NOT NULL, " . "url VARCHAR(255) NOT NULL, " . "weight INT NOT NULL DEFAULT '0' " . ") ENGINE = InnoDB",
				"ALTER TABLE `library_links` ADD INDEX `libraryId` (`libraryId`)",
			],
		],

		'library_links_show_html' => [
		...
		'library_top_links' => [
			...
			'continueOnError' => true,
			'sql' => [
				"CREATE TABLE IF NOT EXISTS library_top_links (" . "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, " . "libraryId INT NOT NULL, " . "linkText VARCHAR(100) NOT NULL, " . "url VARCHAR(255) NOT NULL, " . "weight INT NOT NULL DEFAULT '0' " . ") ENGINE = InnoDB",
		...
		'library_prevent_expired_card_login' => [
		...
		'remove_library_location_boosting' => [
		...
		'library_location_repeat_online' => [
		...
		'library_location_display_controls' => [
		...
		'library_facets' => [
			...
			'continueOnError' => true,
			'sql' => [
				"CREATE TABLE IF NOT EXISTS library_facet_setting (" . "`id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY, " . "`libraryId` INT NOT NULL, " . "`displayName` VARCHAR(50) NOT NULL, " . "`facetName` VARCHAR(50) NOT NULL, " . "weight INT NOT NULL DEFAULT '0', " . "numEntriesToShowByDefault INT NOT NULL DEFAULT '5', " . "showAsDropDown TINYINT NOT NULL DEFAULT '0', " . "sortMode ENUM ('alphabetically', 'num_results') NOT NULL DEFAULT 'num_results', " .
				"showAboveResults TINYINT NOT NULL DEFAULT '0', " . "showInResults TINYINT NOT NULL DEFAULT '1', " . "showInAuthorResults TINYINT NOT NULL DEFAULT '1', " . "showInAdvancedSearch TINYINT NOT NULL DEFAULT '1' " . ") ENGINE = InnoDB COMMENT = 'A widget that can be displayed within VuFind or within other sites' ",
				"ALTER TABLE `library_facet_setting` ADD UNIQUE `libraryFacet` (`libraryId`, `facetName`)",
			],
		],

		'library_archive_search_facets' => [
			...
			'continueOnError' => true,
			'sql' => [
				"CREATE TABLE IF NOT EXISTS `library_archive_search_facet_setting` (" . "`id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY, " . "`libraryId` INT NOT NULL, " . "`displayName` VARCHAR(50) NOT NULL, " . "`facetName` VARCHAR(80) NOT NULL, " . "weight INT NOT NULL DEFAULT '0', " . "numEntriesToShowByDefault INT NOT NULL DEFAULT '5', " . "showAsDropDown TINYINT NOT NULL DEFAULT '0', " . "sortMode ENUM ('alphabetically', 'num_results') NOT NULL DEFAULT 'num_results', " .
				"showAboveResults TINYINT NOT NULL DEFAULT '0', " . "showInResults TINYINT NOT NULL DEFAULT '1', " . "showInAuthorResults TINYINT NOT NULL DEFAULT '1', " . "showInAdvancedSearch TINYINT NOT NULL DEFAULT '1', " . "`collapseByDefault` TINYINT DEFAULT '0', " . "`useMoreFacetPopup` TINYINT DEFAULT '1', " . "UNIQUE KEY `libraryFacet` (`libraryId`,`facetName`)," . "KEY `libraryId` (`libraryId`)" . ") ENGINE = InnoDB DEFAULT CHARSET=utf8 ",
			],
		],
		...
		'location_facets' => [
			...
			'continueOnError' => true,
			'sql' => [
				"CREATE TABLE IF NOT EXISTS location_facet_setting (" . "`id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY, " . "`locationId` INT NOT NULL, " . "`displayName` VARCHAR(50) NOT NULL, " . "`facetName` VARCHAR(50) NOT NULL, " . "weight INT NOT NULL DEFAULT '0', " . "numEntriesToShowByDefault INT NOT NULL DEFAULT '5', " . "showAsDropDown TINYINT NOT NULL DEFAULT '0', " . "sortMode ENUM ('alphabetically', 'num_results') NOT NULL DEFAULT 'num_results', " .
				"showAboveResults TINYINT NOT NULL DEFAULT '0', " . "showInResults TINYINT NOT NULL DEFAULT '1', " . "showInAuthorResults TINYINT NOT NULL DEFAULT '1', " . "showInAdvancedSearch TINYINT NOT NULL DEFAULT '1', " . "INDEX (locationId) " . ") ENGINE = InnoDB COMMENT = 'A widget that can be displayed within VuFind or within other sites' ",
		...
		'location_increase_code_column_size' => [
		...
		'location_sublocation_uniqueness' => [
		...
		'archive_more_details_customization' => [
		...
		'availability_toggle_customization' => [
		...
		'detailed_hold_notice_configuration' => [
		...
		'show_catalog_options_in_profile' => [
		...
		'additional_library_contact_links' => [
		...
		'pinterest_library_contact_links' => [
		...
		'goodreads_library_contact_link' => [
		...
		'additional_locations_for_availability' => [
		...
		'full_record_view_configuration_options' => [
		...
		'search_results_view_configuration_options' => [
		...
		'browse_category_default_view_mode' => [
		...
		'show_place_hold_on_unavailable' => [
		...
		'always_show_search_results_Main_details' => [
		...
		'disable_auto_correction_of_searches' => [
		...
		'public_lists_to_include_defaults' => [
		...
		'remove_consortial_results_in_search' => [
		...
		'remove_unused_enrichment_and_full_record_options' => [
		...
		'remove_unused_location_options_2015_14_0' => [
		...
		'show_library_hours_notice_on_account_pages' => [
		...
		'library_max_fines_for_account_update' => [
		...
		'library_eds_search_integration' => [
		...
		'library_patronNameDisplayStyle' => [
		...
		'location_additional_branches_to_show_in_facets' => [
		...
		'location_library_control_shelf_location_and_date_added_facets' => [
		...
		'library_archive_material_requests' => [
		...
		'library_archive_material_request_form_configurations' => [
			...
			'sql' => [
				'ALTER TABLE `library` ' . 'ADD COLUMN `archiveRequestFieldName` TINYINT(1) NULL,' . 'ADD COLUMN `archiveRequestFieldAddress` TINYINT(1) NULL AFTER `archiveRequestFieldName`,' . 'ADD COLUMN `archiveRequestFieldAddress2` TINYINT(1) NULL AFTER `archiveRequestFieldAddress`,' . 'ADD COLUMN `archiveRequestFieldCity` TINYINT(1) NULL AFTER `archiveRequestFieldAddress2`,' . 'ADD COLUMN `archiveRequestFieldState` TINYINT(1) NULL AFTER `archiveRequestFieldCity`,' .
				'ADD COLUMN `archiveRequestFieldZip` TINYINT(1) NULL AFTER `archiveRequestFieldState`,' . 'ADD COLUMN `archiveRequestFieldCountry` TINYINT(1) NULL AFTER `archiveRequestFieldZip`,' . 'ADD COLUMN `archiveRequestFieldPhone` TINYINT(1) NULL AFTER `archiveRequestFieldCountry`,' . 'ADD COLUMN `archiveRequestFieldAlternatePhone` TINYINT(1) NULL AFTER `archiveRequestFieldPhone`,' . 'ADD COLUMN `archiveRequestFieldFormat` TINYINT(1) NULL AFTER `archiveRequestFieldAlternatePhone`,' .
		...
		'library_archive_related_objects_display_mode' => [
		...
		'library_archive_request_customization' => [
		...
		'library_claim_authorship_customization' => [
		...
		'allow_reading_history_display_in_masquerade_mode' => [
		...
		'materials_request_days_to_keep' => [
		...
		'explore_more_configuration' => [
			...
			'sql' => [
				'CREATE TABLE `library_archive_explore_more_bar` (' . '`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,' . '`libraryId` INT(11) NOT NULL,' . '`section` VARCHAR(45) DEFAULT NULL,' . '`displayName` VARCHAR(45) DEFAULT NULL,' . '`openByDefault` TINYINT(1) UNSIGNED NOT NULL DEFAULT \'1\',' . '`weight` INT(11) NOT NULL DEFAULT \'0\',' . 'PRIMARY KEY (`id`),' . 'KEY `LibraryIdIndex` (`libraryId`)' . ') ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;',
			],
		],

		'archive_object_filtering' => [
		...
		'archive_collection_default_view_mode' => [
		...
		'show_grouped_hold_copies_count' => [
		...
		'location_include_library_records_to_include' => [
		...
		'library_show_series_in_main_details' => [
		...
		'library_remove_unusedDisplayOptions_3_18' => [
		...
		'library_remove_unused_recordsToBlackList' => [
...
//				"DROP TABLE library_facet_setting",
		...
		'library_add_can_update_phone_number' => [
