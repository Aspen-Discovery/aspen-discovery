		...
		$structure = [
			...
			'searchingSection' => ['property'=>'searchingSection', 'type' => 'section', 'label' =>'Searching', 'renderAsHeading' => true, 'hideInLists' => true,
				...
				'properties' => [
					...
					'searchFacetsSection' => array('property' => 'searchFacetsSection', 'type' => 'section', 'label' => 'Search Facets', 'hideInLists' => true, 'expandByDefault' => true, 'properties' => array(
						...
						'baseAvailabilityToggleOnLocalHoldingsOnly' => array('property' => 'baseAvailabilityToggleOnLocalHoldingsOnly', 'type' => 'checkbox', 'label' => 'Base Available Toggle On Local Holdings Only', 'default' => false, 'forcesReindex' => true),
			...
			'fullRecordSection' => array('property'=>'fullRecordSection', 'type' => 'section', 'label' =>'Full Record Display', 'renderAsHeading' => true, 'hideInLists' => true,
				'helpLink'=>'', 'properties' => array(
					...
					'showStaffView' => array('property'=>'showStaffView', 'type'=>'enum', 'values'=>[0 => 'Do not show', 1 => 'Show for all users', 2 => 'Show for staff only'], 'label'=>'Show Staff View', 'description'=>'Whether or not the staff view is displayed in full record view.', 'hideInLists' => true, 'default'=>true),
