...
public class KohaExportMain {
	...
	private static void updateBranchInfo(Connection dbConn, Connection kohaConn) {
		try {
			...
			PreparedStatement addAspenLibraryRecordsToIncludeStmt = dbConn.prepareStatement("INSERT INTO library_records_to_include (libraryId, indexingProfileId, location, subLocation, weight) VALUES (?, ?, '.*', '', 1, 2)");
