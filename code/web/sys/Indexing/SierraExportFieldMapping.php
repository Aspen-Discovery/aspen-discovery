...
class SierraExportFieldMapping extends DataObject{
	...
	public $fixedFieldDestinationField;
	public $bcode3DestinationSubfield;
	public $materialTypeSubfield;
	public $bibLevelLocationsSubfield;
    ...
    static function getObjectStructure(){
		...
		$structure = array(
			...
			'fixedFieldDestinationField' => array('property' => 'fixedFieldDestinationField', 'type' => 'text', 'label' => 'Fixed Field Destination Tag', 'maxLength' => 3, 'description' => 'The MARC field where fixed field data should be stored'),
			...
			'materialTypeSubfield' => array('property' => 'materialTypeSubfield', 'type' => 'text', 'label' => 'Material Type Destination Subfield', 'maxLength' => 1, 'description' => 'Subfield for where Material Type should be stored'),
			'bibLevelLocationsSubfield' => array('property' => 'bibLevelLocationsSubfield', 'type' => 'text', 'label' => 'Bib Level Locations Destination Subfield', 'maxLength' => 1, 'description' => 'Subfield for where Bib Level Location information should be stored'),
