		...
		<div class='issue-summary-row'>
			...
			<div class='issue-summary-details'>
				...
				{if $showCheckInGrid && $issueSummary.checkInGridId}
					&nbsp;
					<span id='showCheckInGrid-{$smarty.foreach.summaryLoop.iteration}' class='btn btn-xs btn-info'>{translate text="Show Check-in Grid"}</span>
					<script	type="text/javascript">
