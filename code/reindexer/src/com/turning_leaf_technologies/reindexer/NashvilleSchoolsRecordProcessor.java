...
class NashvilleSchoolsRecordProcessor extends IlsRecordProcessor {
	...
	NashvilleSchoolsRecordProcessor(GroupedWorkIndexer groupedWorkIndexer, Connection dbConn, ResultSet indexingProfileRS, Logger logger, boolean fullReindex) {
		super(groupedWorkIndexer, dbConn, indexingProfileRS, logger, fullReindex);
