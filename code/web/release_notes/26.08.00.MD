...
- Makes Keyword the singular, default search, ([DIS-2459](https://aspen-discovery.atlassian.net/browse/DIS-2459)) (*BNJ*) 
- Puts the search button to the right of the search box
- Moves ‘Advanced Search’ to the Search Dropdown. 
