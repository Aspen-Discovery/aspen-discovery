			...
			<div class="archiveComponentBody">
				<div class="archiveComponentBox">
					...
					<div class="archiveComponentRandomImage row">
						...
						<a href="#" onclick="return AspenDiscovery.Archive.nextRandomObject('{$randomObjectPids}');"><img id="refreshRandomImage" src="/interface/themes/responsive/images/refresh.png" alt="New Random Image"></a>
					</div>
				</div>
			</div>
		</div>
