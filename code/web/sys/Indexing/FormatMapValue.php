...
class FormatMapValue extends DataObject
{
	...
	static function getObjectStructure()
	{
		...
		return array(
			...
			'format' => array('property' => 'format', 'type' => 'text', 'label' => 'Format', 'description' => 'The detailed format', 'maxLength' => '255', 'required' => true, 'forcesReindex' => true),
			...
			'formatBoost' => array('property' => 'formatBoost', 'type' => 'integer', 'label' => 'Format Boost', 'description' => 'The Format Boost to apply during indexing', 'default' => 1, 'required' => true, 'forcesReindex' => true),
