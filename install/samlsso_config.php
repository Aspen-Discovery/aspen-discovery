...
$config = array(
     ...
     * root directory.
     */
    'certdir' => '/etc/simplesamlphp/cert/',
    'loggingdir' => '/etc/simplesamlphp/log/',
    'datadir' => '/etc/simplesamlphp/data/',
    ...
    'technicalcontact_email' => 'SSO_EMAIL',
     ...
     */
    'auth.adminpassword' => 'SSO_ADMINPASSWORD',
    ...
    'metadata.sources' => array(
        array(
            'type'      => 'flatfile',
            'directory' => '/etc/simplesamlphp/metadata'
        ),
    ),
