	...
	<div id="main-content">
		<div class="btn-group">
			...
			{foreach from=$additionalObjectActions item=action}
				...
				{/if}
			{/foreach}
			<a class="btn btn-sm btn-default" href='/ILS/IndexingProfiles?objectAction=list'><i class="fas fa-arrow-alt-circle-left" role="presentation"></i> {translate text="Return to List" isAdminFacing=true}</a>
		</div>
