...
class VdxSetting extends DataObject {
	...
	public static function getObjectStructure(): array
	{
		return [
			...
			'submissionEmailAddress' => ['property' => 'submissionEmailAddress', 'type' => 'text', 'label' => 'Submission Email Address', 'description' => 'The Address where new submissions are sent (separate multiple addresses with semi-colons)', 'maxLength' => 255],
