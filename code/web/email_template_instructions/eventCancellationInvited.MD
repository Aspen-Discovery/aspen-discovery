Sent to a patron who had been invited from the waiting list to register for an event when that event is cancelled or rescheduled before they completed registration.
...
Template variables are case-insensitive and should be enclosed within percent symbols. I.e.
  ...
  _Hello %user.firstname%, the event you had been invited to register for at %library.displayName% has been %changeType%._
