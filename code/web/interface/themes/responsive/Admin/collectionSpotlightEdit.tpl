...
{strip}
	<div id="main-content">
		...
		<div class="btn-group">
			...
			{if $canDelete}
				<a class="btn btn-sm btn-danger" href="/Admin/CollectionSpotlights?objectAction=delete&id={$object->id}" onclick="return confirm('{translate text="Are you sure you want to delete %1%?" 1=$object->name inAttribute=true isAdminFacing=true}');">{translate text="Delete" isAdminFacing=true}</a>
			{/if}
		</div>
