{strip}
	<div class="col-xs-12">
		...
		{foreach from=$resourcesByCategory key=category item=resources}
			<div class="panel resourceCategory" id="{$category|replace:' ':''|escape:css}Panel">
				<a data-toggle="collapse" href="#{$category|replace:' ':''|escape:css}PanelBody">
				...
				<div id="{$category|replace:' ':''|escape:css}PanelBody" class="panel-collapse collapse">
						...
						{foreach from=$resources item=resource}
							<div class="row">
								...
								<div class="col-xs-9 col-sm-9 col-md-9 col-lg-10">
									<div>
										<a href="/WebBuilder/WebResource/{$resource->id}" class="result-title">
											{$resource->name}
										</a>
									</div>
									<div>
