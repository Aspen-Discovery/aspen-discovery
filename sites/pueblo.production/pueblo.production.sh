...
if [[ ( "$1" == "start" ) || ( "$1" == "restart") ]]
	then
    	runuser solr -c '/usr/local/aspen-discovery/sites/default/solr-7.6.0/bin/solr start -m 3g -p 8080 -s "/data/aspen-discovery/pueblo.production/solr7" -d "/usr/local/aspen-discovery/sites/default/solr-7.6.0/server"'
fi
