...
#cd /usr/local/aspen-discovery/code/overdrive_api_extract; java -jar overdrive_extract.jar {sitename} &
#sleep 5
#echo "Starting Cloud Library export"
#cd /usr/local/aspen-discovery/code/cloudlibrary_export; java -jar cloud_library_export.jar {sitename} &
#sleep 5
