{strip}
	...
	{if $debugJs}
		...
		<script src="{$path}/interface/themes/responsive/js/aspen/cloud-library.js?v={$gitBranch|urlencode}"></script>
		...
		<script src="{$path}/interface/themes/responsive/js/aspen/websites.js?v={$gitBranch|urlencode}"></script>
