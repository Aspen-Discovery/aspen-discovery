...
class LibraryTopLinks extends DataObject{
	...
	static function getObjectStructure(){
		...
		$structure = array(
			...
			'weight' => array('property' => 'weight', 'type' => 'numeric', 'label' => 'Weight', 'weight' => 'Defines how items are sorted.  Lower weights are displayed to the left of the screen.', 'required'=> true),
