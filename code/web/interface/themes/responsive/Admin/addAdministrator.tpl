...
<div id="main-content" class="col-tn-12 col-xs-12">
	...
	<form name="addAdministrator" method="post" enctype="multipart/form-data" class="form-horizontal">
		<fieldset>
			...
			<div class="form-group">
				<div class="controls">
					<input type="submit" name="submit" value="{translate text="Update User" inAttribute=true isAdminFacing=true}" class="btn btn-primary">  <a href='/Admin/{$toolName}?objectAction=list' class="btn btn-default"><i class="fas fa-arrow-alt-circle-left" role="presentation"></i> {translate text="Return to List" isAdminFacing=true}</a>
				</div>
			</div>
		</fieldset>
	</form>
