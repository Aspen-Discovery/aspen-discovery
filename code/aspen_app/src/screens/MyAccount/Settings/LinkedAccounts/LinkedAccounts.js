    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        <Box flex={1} safeArea={5}>
          <DisplayMessage
            type="info"
            message={translate("linked_accounts.info_message")}
          />
          <Heading fontSize="lg" pb={2}>
            {translate("linked_accounts.additional_accounts")}
          </Heading>
          <Text>
            {translate("linked_accounts.following_accounts_can_manage")}
          </Text>
          <FlatList
            data={this.state.linkedAccounts}
            renderItem={({ item }) =>
              this.renderLinkedAccounts(item, library.baseUrl)
            }
          ...
          <AddLinkedAccount
            ...
            _updateLinkedAccounts={this._updateLinkedAccounts}
          />
          <Divider my={4} />
          <Heading fontSize="lg" pb={2}>
          ...
          <Text>
            {translate("linked_accounts.following_accounts_can_view")}
          </Text>
          <FlatList
