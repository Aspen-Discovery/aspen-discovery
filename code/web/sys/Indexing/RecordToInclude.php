...
class RecordToInclude extends DataObject{
	...
	static function getObjectStructure(){
		...
		$structure = array(
			...
			'includeItemsOnOrder' => array('property'=>'includeItemsOnOrder', 'type'=>'checkbox', 'label'=>'Include Items On Order', 'description'=>'Whether or not order records are included', 'default' => 1),
			'includeEContent' => array('property'=>'includeEContent', 'type'=>'checkbox', 'label'=>'Include e-content Items', 'description'=>'Whether or not e-Content should be included', 'default' => 1),
