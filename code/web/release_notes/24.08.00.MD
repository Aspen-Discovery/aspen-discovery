...
- Added a page to the user account section named My Privacy Settings to allow users to change their preferences once set. 
...
- Added an icon next to the External Search Services option on the Cookie Consent pop up and in My Privacy Settings that informs users of what services they are giving consent to based on which modules anre enabled on their library system. 
