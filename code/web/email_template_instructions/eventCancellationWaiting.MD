Sent to a patron who was still on the waiting list for an event when that event is cancelled or rescheduled.
...
Template variables are case-insensitive and should be enclosed within percent symbols. I.e.
  ...
  _Hello %user.firstname%, the event you were on the waiting list for at %library.displayName% has been %changeType%._
