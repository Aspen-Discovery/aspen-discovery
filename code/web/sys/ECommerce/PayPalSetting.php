...
class PayPalSetting extends DataObject
{
	...
	static function getObjectStructure() : array {
		...
		$structure = array(
			...
			'sandboxMode' => array('property'=>'sandboxMode', 'type'=>'checkbox', 'label'=>'Use PayPal Sandbox (for testing payments only, does not collect money)', 'description'=>'Whether or not to use PayPal in Sandbox mode', 'hideInLists' => false,'note'=>'This is for testing only! No funds will be received by the library.'),
