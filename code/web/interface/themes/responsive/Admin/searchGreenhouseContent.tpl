<form role="form" id="searchGreenhouseContentForm">
	...
	<div class="form-group">
		...
		<div class="input-group input-group-sm">
			...
			<span class="btn btn-sm btn-primary input-group-addon" onclick="return AspenDiscovery.Admin.searchGreenhouseContent();">{translate text="Search" isPublicFacing=true}</span>
		</div>
	</div>
</form>
<div class="col-xs-12">
