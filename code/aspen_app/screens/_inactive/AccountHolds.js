...
async function freezeHold(cancelId, recordId, source) {
    ...
    const api = create({ baseURL: 'https://aspen-test.bywatersolutions.com/API', timeout: 10000 });
    const response = await api.get('/UserAPI?method=freezeHold', { username: base64.decode(global.userKey), password: base64.decode(global.secretKey), sessionId: global.sessionId, holdId: cancelId, recordId: recordId, itemSource: source });
...
async function thawHold(cancelId, recordId, source) {
    const api = create({ baseURL: 'https://aspen-test.bywatersolutions.com/API', timeout: 10000 });
    const response = await api.get('/UserAPI?method=activateHold', { username: base64.decode(global.userKey), password: base64.decode(global.secretKey), sessionId: global.sessionId, holdId: cancelId, recordId: recordId, itemSource: source });
...
async function cancelHold(cancelId, recordId, source) {
    const api = create({ baseURL: 'https://aspen-test.bywatersolutions.com/API', timeout: 10000 });
    const response = await api.get('/UserAPI?method=cancelHold', { username: base64.decode(global.userKey), password: base64.decode(global.secretKey), sessionId: global.sessionId, cancelId: cancelId, recordId: recordId, itemSource: source });
...
async function changeHoldPickUpLocation(holdId, newLocation) {
    const api = create({ baseURL: 'https://aspen-test.bywatersolutions.com/API', timeout: 10000 });
    const response = await api.get('/UserAPI?method=changeHoldPickUpLocation', { username: base64.decode(global.userKey), password: base64.decode(global.secretKey), sessionId: global.sessionId, holdId: cancelId, location: newLocation });
