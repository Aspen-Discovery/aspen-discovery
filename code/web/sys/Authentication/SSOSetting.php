			...
			'samlConfigSection' => [
				...
				'properties' => [
					...
					'ssoCategoryIdSection' => [
						...
						'label' => 'Patron Type',
						'hideInLists' => true,
						'note' => 'Users will also be assigned any roles and permissions tied to this patron type',
						'renderAsHeading' => true,
						'headingLevel' => 'h3',
						'showBottomBorder' => true,
						'properties' => [
					...
					'samlStaffSection' => [
						...
						'showBottomBorder' => true,
						'headingLevel' => 'h3',
						'note' => 'Leave empty to assign the value from Patron Type settings in the previous section. Users will also be assigned any roles and permissions tied to this patron type',
						'properties' => [
							'ssoStaffPTypeAttr' => [
								'property' => 'samlStaffPTypeAttr',
								'type' => 'text',
								'label' => 'IdP attribute that determines if the user should be a staff patron type',
								'description' => 'The user\'s patron category id, this should be an id that is recognised by your LMS/ILS. If this is not supplied, please provide a fallback value below',
								'size' => '512',
								'hideInLists' => true,
							],
							'ssoStaffPTypeAttrValue' => [
								...
								'type' => 'text',
								'label' => 'The value from the IdP attribute that determines if the user should be a staff patron type',
								'description' => 'The value from the IdP attribute defined in the previous field that determines if the user should be assigned a staff patron type',
								'size' => '512',
								'hideInLists' => true,
							],
