...
class Theme extends DataObject
{
	...
	static function getObjectStructure() : array
	{
		...
		return [
			...
			'fullWidth' => ['property' => 'fullWidth', 'type' => 'checkbox', 'label' => 'Make header and footer full width', 'description' => 'Whether or not the header and footer should be full width', 'required' => false],
