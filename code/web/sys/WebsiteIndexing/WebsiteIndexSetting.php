...
class WebsiteIndexSetting extends DataObject
{
	...
	public /** @noinspection PhpUnused */$maxPagesToIndex;
	public $deleted;
	public /** @noinspection PhpUnused */$crawlDelay;
	...
	public static function getObjectStructure() : array
	{
		...
		return [
			...
			'pageTitleExpression' => ['property'=>'pageTitleExpression', 'type'=>'regularExpression', 'label'=>'Regular Expression to find Page Title (ok to leave blank)', 'description'=>'A regular expression to use to load the title from.  Will use the value of the first group identified.', 'maxLength'=>255, 'required' => false, 'default' => '', 'hideInLists' => true],
			'descriptionExpression' => ['property'=>'descriptionExpression', 'type'=>'regularExpression', 'label'=>'Regular Expression to find Description (ok to leave blank)', 'description'=>'A regular expression to use to load the description from.  Will use the value of the first group identified.', 'maxLength'=>255, 'required' => false, 'default' => '', 'hideInLists' => true],
			'pathsToExclude' => ['property' => 'pathsToExclude', 'type'=>'textarea', 'label'=>'Paths to exclude (regular expression)', 'description'=>'A list of URLs to exclude from the index with each on it\'s own line.', 'note'=> 'Each URL is matched against the paths to see if it should be excluded, the entire path must match so to exclude a directory end with .*.', 'hideInLists' => true],
			...
			'crawlDelay' => ['property' => 'crawlDelay', 'type'=>'integer', 'label'=>'Crawl Delay', 'description'=>'The number of seconds to delay between requesting pages from the site.', 'default' => 10],
