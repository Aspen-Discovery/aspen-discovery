...
//						if($tmpResult['success']){$success++;}
	...
	public function getAdminActions() {
		...
		$sections['ecommerce']->addAction(new AdminAction('Delux Certified Payments Settings', 'Define Settings for Delux Certified Payments.', '/Admin/DeluxCertifiedPaymentsSettings'), 'Administer Delux Certified Payments');
