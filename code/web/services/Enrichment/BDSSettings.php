...
class Enrichment_BDSSettings extends ObjectEditor {
	...
	function getObjectStructure($context = ''): array {
		return BDSSetting::getObjectStructure($context);
	}
	...
	function getBreadcrumbs(): array {
		...
		$breadcrumbs[] = new Breadcrumb('/Enrichment/BDSSettings', 'BDS Settings');
		return $breadcrumbs;
	}
