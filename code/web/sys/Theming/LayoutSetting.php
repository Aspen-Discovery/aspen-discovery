...
class LayoutSetting extends DataObject
{
	...
	static function getObjectStructure(){
		$structure = [
			...
			'showSidebarMenu' => array('property'=>'showSidebarMenu', 'type'=>'checkbox', 'label'=>'Display Sidebar Menu', 'description'=>'Determines whether or not the sidebar menu will be shown.  Must also be enabled in config.ini.', 'default' => true),
