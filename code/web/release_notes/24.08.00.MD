...
- Added an icon next to the External Search Services option on the Cookie Consent pop up and in My Cookie Preferences that informs users of what services they are giving consent to based on which modules anre enabled on their library system. 
