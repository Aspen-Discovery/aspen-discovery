...
cd /usr/local/aspen-discovery/code/overdrive_extract; java -jar overdrive_extract.jar pueblo.production &
sleep 5
echo "Starting Cloud Library export"
cd /usr/local/aspen-discovery/code/cloud_library_export; java -jar cloud_library_export.jar pueblo.production &
sleep 5
