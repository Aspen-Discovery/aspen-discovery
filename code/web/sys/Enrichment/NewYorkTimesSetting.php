	...
	public static function getObjectStructure($context = ''): array {
		return [
			...
			'runFullUpdate' => [
				...
				'default' => 0,
				'note' => "If enabled, the updater will automatically run in a couple of minutes. Do not run full updates often because there are rate limits to the NYT API. Regular updates run once a week.",
			],
