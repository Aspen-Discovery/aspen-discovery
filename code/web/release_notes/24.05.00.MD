...
- When determining the author to display for a grouped work, first look at records with a format category of book and then records with a format category of eBook. (Ticket 107476, 120604, 131291) (*MDN*)
...
//Lucas
### Custom Forms
- Now, if you need to be logged in to fill a custom form out, Aspen will redirect you correctly to the form instead a 404 page. (Ticket 125037) (*LM*)
