...
class LibraryLink extends DataObject{
	...
	static function getObjectStructure() : array {
		...
		return [
			...
			'iconName' => ['property'=>'iconName', 'type' => 'text', 'label' => 'FontAwesome Icon Name <small><a href="https://fontawesome.com/cheatsheet/free/solid" target="_blank"><i class="fa fa-info-circle"></i></a></small>', 'description'=>'Show a font awesome icon next to the menu name'],
			...
			'showInTopMenu' => ['property'=>'showInTopMenu', 'type'=>'checkbox', 'label'=>'Show In Top Menu <span class="label label-default">Large Screens Only</span>', 'description'=>'Show the link in the top menu for large screens', 'default'=>0],
			'alwaysShowIconInTopMenu' => ['property'=>'alwaysShowIconInTopMenu', 'type'=>'checkbox', 'label'=>'Show Icon In Top Menu <span class="label label-default">All Screen Sizes</span>', 'description'=>'Always show the icon in the top menu at all screen sizes', 'default'=>0],
