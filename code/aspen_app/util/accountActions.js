...
export async function renewCheckout(barcode, recordId, source, itemId) {
    ...
    const postBody = await postData();
    const api = create({ baseURL: global.libraryUrl + '/API', timeout: global.timeoutAverage, headers: getHeaders(true), params: { itemBarcode: validId, recordId: recordId, itemSource: source }, auth: createAuthTokens() });
...
export async function returnCheckout(userId, id, source, overDriveId) {
    ...
    const api = create({ baseURL: global.libraryUrl + '/API', timeout: global.timeoutFast, headers: getHeaders(), auth: createAuthTokens(), params: { id: itemId, patronId: userId, itemSource: source } });
...
export async function viewOnlineItem(userId, id, source, accessOnlineUrl) {
    ...
    if (source == "hoopla") {
        const api = create({ baseURL: global.libraryUrl + '/API', timeout: global.timeoutFast, headers: getHeaders(), auth: createAuthTokens(), params: { patronId: userId, itemId: id, itemSource: source } });
...
export async function viewOverDriveItem(userId, formatId, overDriveId) {
    ...
    const api = create({ baseURL: global.libraryUrl + '/API', timeout: global.timeoutFast, headers: getHeaders(), auth: createAuthTokens(), params: { patronId: userId, overDriveId: overDriveId, formatId: formatId, itemSource: "overdrive" } });
    const response = await api.post('/UserAPI?method=viewOnlineItem', postBody);
...
export async function freezeHold(cancelId, recordId, source) {
    ...
    const api = create({ baseURL: global.libraryUrl + '/API', timeout: global.timeoutFast, headers: getHeaders(), auth: createAuthTokens(), params: { sessionId: global.sessionId, holdId: cancelId, recordId: recordId, itemSource: source, reactivationDate: reactivationDate, patronId: global.patronId } });
...
export async function thawHold(cancelId, recordId, source) {
    ...
    const api = create({ baseURL: global.libraryUrl + '/API', timeout: global.timeoutAverage, headers: getHeaders(), auth: createAuthTokens(), params: { sessionId: global.sessionId, holdId: cancelId, recordId: recordId, itemSource: source, patronId: global.patronId } });
...
export async function cancelHold(cancelId, recordId, source) {
    const postBody = await postData();
    const api = create({ baseURL: global.libraryUrl + '/API', timeout: global.timeoutFast, headers: getHeaders(), auth: createAuthTokens(), params: { sessionId: global.sessionId, cancelId: cancelId, recordId: recordId, itemSource: source, patronId: global.patronId } });
...
export async function changeHoldPickUpLocation(holdId, newLocation) {
    const postBody = await postData();
    const api = create({ baseURL: global.libraryUrl + '/API', timeout: global.timeoutFast, headers: getHeaders(), auth: createAuthTokens(), params: { sessionId: global.sessionId, holdId: holdId, newLocation: newLocation } });
...
export async function updateOverDriveEmail(itemId, source, patronId, overdriveEmail, promptForOverdriveEmail) {
    const postBody = await postData();
    const api = create({ baseURL: global.libraryUrl + '/API', timeout: global.timeoutAverage, headers: getHeaders(), auth: createAuthTokens(), params: { itemId: itemId, itemSource: source, patronId: patronId, overdriveEmail: overdriveEmail, promptForOverdriveEmail: promptForOverdriveEmail } });
