			...
			<div class="row">
				<div class="resultDetails col-xs-12 col-md-9">
					...
					<div class="row">
						...
						<div class="result-value col-tn-8 col-lg-9">{implode subject=$record->getFormats() translate=true} - Axis 360</div>
					</div>
				...
				<div class="col-xs-9 col-sm-8 col-md-4 col-lg-3">
					<div class="btn-group btn-group-vertical btn-block">
						{if !empty($record->accessOnlineUrl)}
							<a href="{$record->accessOnlineUrl}" target="_blank" class="btn btn-sm btn-action btn-wrap"><i class="fas fa-external-link-alt"></i> {translate text='Open in Axis 360'}</a>
						{/if}
						{if $record->canRenew}
