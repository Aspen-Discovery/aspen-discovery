...
class AccountProfile extends DataObject {
    ...
    static function getObjectStructure() {
		$structure = array(
			...
			'ils' => array('property' => 'ils', 'type' => 'enum', 'label' => 'ILS', 'values' => ['na' => 'None', 'koha' => 'Koha', 'carlx' => 'Carl.X', 'horizon' => 'Horizon', 'millennium' => 'Millennium', 'sierra' => 'Sierra', 'symphony' => 'Symphony'], 'description' => 'The ils of the account profile', 'required' => true, 'default' => 'koha'),
