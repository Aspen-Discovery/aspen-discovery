	...
	<form enctype="multipart/form-data" name="setRelatedCover" id="setRelatedCover" method="post" action="/GroupedWork/{$groupedWorkId}/AJAX">
		...
		<div class="form-group">
			<div id="recordCover" class="text-center row">
				<img alt="{translate text='Book Cover' inAttribute=true isPublicFacing=true}" class="img-thumbnail{if $useOriginalCoverUrls} use-original-covers{/if} {$coverStyle}" src="/bookcover.php?id={$recordId}&size=medium&type={$recordType}" role="presentation">
			</div>
