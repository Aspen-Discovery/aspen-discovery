...
public class RecordGroupingProcessor {
	...
	public String processRecord(RecordIdentifier primaryIdentifier, String title, String subtitle, String author, String format, boolean primaryDataChanged){
		...
		if (formatsToGroupingCategory.containsKey(format.toLowerCase())){
			groupedWork.setGroupingCategory(formatsToGroupingCategory.get(format.toLowerCase()));
		} else {
	...
	static {
		...
		formatsToGroupingCategory.put("videosisc", "movie");
