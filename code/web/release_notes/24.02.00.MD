...
- Added the ability to retreive the place of publication for records so that this information can be used to complete the 'CY' section of the Ris Citations.(*AB*)
