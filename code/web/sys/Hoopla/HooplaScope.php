	...
	static function getObjectStructure(string $context = ''): array {
		...
		$structure = [
			...
			'excludeTitlesWithCopiesFromOtherVendors' => [
				...
				'values' => [
					0 => 'Show all titles',
					1 => 'Hide Hoopla Instant titles if other copies are available',
					2 => 'Hide Hoopla Instant titles if other copies are owned',
				],
				'label' => 'Exclude Records With Copies from other eContent Vendors (OverDrive, cloudLibrary, Boundless, etc.)',
				'description' => 'Whether or not records in other collections should be included. Flex titles will still be shown.',
				'default' => 0,
				'forcesReindex' => true,
			],
		];
