{strip}
	...
	<div class="share-tools">
		...
		{if $showEmailThis == 1}
{*			<a href="#" onclick="return AspenDiscovery.Lists.showEmailForm(this, '{$recordDriver->getId()|escape:"url"}')" title="Share via email">*}
...
{*			</a>*}
			<a href="http://www.facebook.com/sharer/sharer.php?u={$eventUrl|escape:'url'}" target="_blank" title="Share on Facebook">
				<img src="{img filename='facebook-icon.png'}" alt="Share on Facebook">
			</a>

			<a href="http://www.pinterest.com/pin/create/button/?url={$eventUrl}&media={$recordDriver->getBookcoverUrl('medium', true)}&description=Pin%20on%20Pinterest" target="_blank" title="Pin on Pinterest">
