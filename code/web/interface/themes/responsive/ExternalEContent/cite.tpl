...
{else}
	<div style="text-align: left;">
		...
		{if $apa}
			<b>{translate text="APA Citation" isPublicFacing=true}</b> <span class="styleGuide"><a href="https://owl.purdue.edu/owl/research_and_citation/apa_style/apa_formatting_and_style_guide/general_format.html">({translate text="style guide" isPublicFacing=true})</a></span>
			<p style="width: 95%; padding-left: 25px; text-indent: -25px;">
				{include file=$apa}
			</p>
		{/if}
		...
		{if $mla}
			<b>{translate text="MLA Citation" isPublicFacing=true}</b> <span class="styleGuide"><a href="https://owl.purdue.edu/owl/research_and_citation/mla_style/mla_formatting_and_style_guide/mla_general_format.html">({translate text="style guide" isPublicFacing=true})</a></span>
			<p style="width: 95%; padding-left: 25px; text-indent: -25px;">
				{include file=$mla}
			</p>
		{/if}
