...
class LayoutSetting extends DataObject
{
	...
	static function getObjectStructure(){
		return [
			...
			'useHomeLink' => array('property' => 'useHomeLink', 'type' => 'enum', 'label' => 'Where to use custom Home Link from Library Settings', 'values' => ['0' => 'Use Default', '1' => 'Use Home Link in Breadcrumbs and Menu', '2' => 'Use Home Link for Logo', '3' => 'Use Home Link for Breadcrumbs, Menu and Logo'], 'description' => 'x', 'default' => '0', 'onchange'=>'return AspenDiscovery.Admin.updateLayoutSettingsFields();'),
