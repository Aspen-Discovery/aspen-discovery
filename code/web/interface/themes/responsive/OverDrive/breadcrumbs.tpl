...
{/if}
&nbsp;{if !$lastSearch}Catalog {/if}{if $recordDriver}<a href="{$path}/GroupedWork/{$recordDriver->getPermanentId()}">{$recordDriver->getTitle()|removeTrailingPunctuation|truncate:30:"..."|escape}</a> <span class="divider">&raquo;</span>
