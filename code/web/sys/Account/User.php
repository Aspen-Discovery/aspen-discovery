...
//						if($tmpResult['success']){$success++;}
	...
	public function getAdminActions() {
		...
		if (array_key_exists('Events', $enabledModules)) {
			...
			$sections['events']->addAction(new AdminAction('Communico Settings', 'Define collections to be loaded into Aspen Discovery.', '/Events/CommunicoSettings'), 'Administer Springshare LibCal Settings');
