...
class Smarty {
	...
	function _fetch_resource_info(&$params) {
		...
		if ($this->_parse_resource_name($_params)) {
			...
			switch ($_resource_type) {
				...
				default:
					...
					if ($params['get_source']) {
						$_source_return = isset($this->_plugins['resource'][$_resource_type]) && call_user_func_array($this->_plugins['resource'][$_resource_type][0][0], [
									$_resource_name,
					...
					$_timestamp_return = isset($this->_plugins['resource'][$_resource_type]) && call_user_func_array($this->_plugins['resource'][$_resource_type][0][1], [
								$_resource_name,
		...
		if (!$_return) {
			if (!$params['quiet']) {
				$this->trigger_error('unable to read resource: "' . $params['resource_base_path'] . $params['resource_name'] . '"');
			}
