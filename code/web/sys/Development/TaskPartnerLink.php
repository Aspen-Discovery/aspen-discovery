...
class TaskPartnerLink extends DataObject {
	...
	static function getObjectStructure() : array{
		...
		return array(
			...
			'partnerId' => array('property' => 'partnerId', 'type' => 'enum', 'values' => $partnerList, 'label' => 'Partner', 'description' => 'The partner who requested the task', 'required' => true),
			'taskId' => array('property'=>'taskId', 'type'=>'enum', 'values'=>$taskList, 'label'=>'Task', 'description'=>'The task related to the partner', 'required' => true),
		);
	}
}