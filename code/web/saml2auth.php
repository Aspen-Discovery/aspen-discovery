...
ExternalRequestLogEntry::logRequest('SAML.usersAttributes', $_SERVER['REQUEST_METHOD'], $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'], getallheaders(), $_POST, '', $usersAttributes, []);
