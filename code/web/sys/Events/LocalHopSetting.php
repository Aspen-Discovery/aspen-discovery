...
/**
 * Settings for LocalHop integration
 */
class LocalHopSetting extends DataObject
{
	public $__table = 'localhop_settings';
	public $id;
	public $name;
	public $baseUrl;
	...
	static function getObjectStructure(string $context = ''): array
	{
		...
		$libraryList = Library::getLibraryList(!UserAccount::userHasPermission('Administer LocalHop Settings'));
	...
	public function getLibraries(): ?array
	{
		if (!isset($this->_libraries) && $this->id) {
			...
			$library->settingSource = 'localhop';
	...
	public function saveLibraries(): void
	{
		if (isset($this->_libraries) && is_array($this->_libraries)) {
			...
			foreach ($this->_libraries as $libraryId) {
				...
				$libraryEventSetting->settingSource = 'localhop';
