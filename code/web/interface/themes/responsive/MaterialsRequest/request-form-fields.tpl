		...
		{foreach from=$formFields item=formField}
			{if $formField->fieldType == 'format'}
				...
				<div class="row form-group">
					<label class="control-label col-sm-3" for="format">{translate text=$formField->fieldLabel isPublicFacing=true isAdminEnteredData=true} <span class="label label-danger" style="margin-left: .5em">{translate text="Required" isPatronFacing=true}</span></label>
				...
				<div class="form-group specialFormatField articleField">
					<label for="magazineTitle" class="col-sm-3 control-label">{translate text='Magazine/Journal Title' isPublicFacing=true} <span class="label label-danger" style="margin-left: .5em">{translate text="Required" isPatronFacing=true}</span></label>
					<div class="col-sm-9">
			...
			{elseif $formField->fieldType == 'title'}
				{assign var="materialRequestTableColumnName" value=$formField->fieldType}
				<div class="row form-group">
					<label id="titleLabel" for="{$materialRequestTableColumnName}" class="control-label col-sm-3">{translate text=$formField->fieldLabel isPublicFacing=true isAdminEnteredData=true} <span class="label label-danger" style="margin-left: .5em">{translate text="Required" isPatronFacing=true}</span></label>
					<label id="articleTitleLabel" for="{$materialRequestTableColumnName}" class="control-label col-sm-3">{translate text="Article Title" isPublicFacing=true} <span class="label label-danger" style="margin-left: .5em">{translate text="Required" isPatronFacing=true}</span></label>
					<div class="request_detail_field_value col-sm-9">
