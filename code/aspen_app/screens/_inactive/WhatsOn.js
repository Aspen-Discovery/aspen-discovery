			...
			<ScrollView contentContainerStyle={{ flexGrow: 1 }}>
				<View style={Stylesheet.outerContainer}>
					...
					<View style={Stylesheet.btnContainer}>
						<TouchableOpacity
							style={Stylesheet.btnFormat}
							onPress={() => {
								this.handleClick(this.state.dataWhatsOn.link);
							}}
						>
					...
					<View style={Stylesheet.btnContainer}>
						<TouchableOpacity
							style={Stylesheet.btnFormat}
							onPress={() => {
								this.handleClick(this.state.dataUniversal.website);
							}}
						>
					...
					<View style={Stylesheet.btnContainer}>
						<TouchableOpacity
							style={Stylesheet.btnFormat}
							onPress={() => {
								this.handleClick(this.state.dataUniversal.catalogue);
							}}
						>
