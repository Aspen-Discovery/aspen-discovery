	...
	{else}{*Default Browse Mode (covers) *}
		<div class="browse-thumbnail grid-item">
			...
			{if $showRatings && $browseCategoryRatingsMode != 0}
				...
				{if $browseCategoryRatingsMode == 1} onclick="return AspenDiscovery.GroupedWork.showReviewForm(this, '{$summId}');" onkeypress="return AspenDiscovery.GroupedWork.showReviewForm(this, '{$summId}');" style="cursor: pointer" title="Write a Review" role="button" tabindex="0" {/if}
