...
class HooplaSetting extends DataObject
{
	...
	public $excludeTitlesWithCopiesFromOtherVendors;
    ...
    public static function getObjectStructure()
    {
        $structure = array(
	        ...
	        'excludeTitlesWithCopiesFromOtherVendors' => array('property' => 'excludeTitlesWithCopiesFromOtherVendors', 'type' => 'checkbox', 'label' => 'Exclude Records With Copies from other eContent Vendors (OverDrive and Rbdigital)', 'description'=>'Whether or not records in other collections should be included', 'default'=>0),
	        ...
	        'apiPassword' => array('property'=>'apiPassword', 'type'=>'storedPassword', 'label'=>'API Password', 'description'=>'The API Password provided by Hoopla when registering'),
